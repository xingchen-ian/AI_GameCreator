...
| --- | --- | --- | --- |
| **01** | Two summer pipelines; MDA as a lens | Hunicke, LeBlanc & Zubek, *MDA* (2004), full paper | — (assignment given in class: play three summer demos; walk both question lists) |
| **02** | Meaningful play; what the pipeline actually emits | Salen & Zimmerman, *Rules of Play*, chapter on meaningful play | Reading response: map one summer game onto Mechanics / Dynamics / Aesthetics. Notes from playing three demos. |
